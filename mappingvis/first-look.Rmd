...
y <- read_sf(file.path(data_dir, "glaciers.geojson")) %>%
  filter(Sub_basin == "Dudh Koshi")
x <- read_subset("/Users/kris/Desktop/teaching/mapping-vis/data/raw/region.vrt", st_bbox(y))
writeRaster(x, file.path(data_dir, "LE07_140041_20071221-subset.tiff"), format="GTiff")
```
```{r}
ggRGB(x, r = 15, g = NULL, b = NULL)
```

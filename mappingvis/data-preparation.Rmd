...
params:
  ...
  out_dir: "/Users/kris/data/processed/test/"
...
different geographic sub-basins for training and evaluation. The list of
training basins was chosen in advance and placed in [this
file](https://uwmadison.box.com/shared/static/2ptmi9b4gt5d5vyusju5u8kn5n1s6hnd.csv),
which is used in the filtering step below. An analogous list for the test data
is
[here](https://uwmadison.box.com/shared/static/iilcsf3bbois8tmt7pklriu219s4wlu6.csv)
and can be used by modifying this rmarkdown's header, in the `basins` parameter.

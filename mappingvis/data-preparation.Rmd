...
params:
  ...
  out_dir: "/Users/kris/Desktop/teaching/mapping-vis/data/test/"
  basins: "/Users/kris/Desktop/teaching/mapping-vis/data/test_list-small.csv"
  n_patches: 25
---
...
k_mat <- k_centers %>%
  dplyr::select(Longitude, Latitude) %>%
  as.matrix()
write_patches(x_path, ys, k_mat, params$out_dir)
```
